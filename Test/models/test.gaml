...
global {
	file shape_file_buildings <- file("SantaLuzia4.shp");
	file shape_file_roads <- file("SantaLuziaEstrada.shp");
	file shape_file_bounds <- file("SantaLuzia.shp");
...
experiment road_traffic type: gui {
	...
	parameter "Earliest hour to start work" var: min_work_start category: "People" min: 2 max: 4;
	parameter "Latest hour to start work" var: max_work_start category: "People" min: 4 max: 8;
	parameter "Earliest hour to end work" var: min_work_end category: "People" min: 16 max: 20;
	parameter "Latest hour to end work" var: max_work_end category: "People" min: 20 max: 23;
